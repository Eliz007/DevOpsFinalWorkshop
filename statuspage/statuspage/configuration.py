...
DATABASE = {
    'NAME': 'status-page-db',         # Database name
    'USER': 'statuspage',               # PostgreSQL username
    'PASSWORD': 'statuspage123',           # PostgreSQL password
...
SECRET_KEY = 'RP82$+3eF#si1GiNjO6zY&&vKr^-P9nclK7SVnSjhH)7oRQVC9' #temp only, will be replaced
